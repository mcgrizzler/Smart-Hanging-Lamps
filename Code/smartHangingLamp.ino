...
FASTLED_USING_NAMESPACE // Find out what this is
...
void setup()
{
    ...
    FastLED.addLeds<LED_TYPE,DATA_PIN,COLOR_ORDER>(leds, NUM_LEDS).setCorrection(TypicalLEDStrip); // Add led's
    FastLED.setBrightness(BRIGHTNESS); // Set LED brightness

    pinMode(9, OUTPUT);  // this pin will pull the HC-10 pin 34 (key pin) HIGH to switch module to AT mode
    digitalWrite(9, HIGH); // write 5v to pin 9
